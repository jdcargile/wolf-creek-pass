...
def sample_mountain_pass():
    return MountainPass(
        ...
        surface_status="Snow/Ice",
        visibility="0.5",
        forecasts="Evening;Snow expected|Morning;Clearing",
        closure_status="OPEN",
        closure_description="Francis to Hanna",
        seasonal_route_name="Route 35",
        seasonal_closure_title="SR 35 Wolf Creek Pass",
    )
...
def sample_mountain_passes():
    return [
        ...
        MountainPass(
            ...
            roadway="I-80 Parleys Canyon",
            elevation_ft="7016",
            latitude=40.75395,
            longitude=-111.6225,
            station_name="I-80 @ Parleys Summit",
            air_temperature="32",
            closure_status="",
        ),
    ]
